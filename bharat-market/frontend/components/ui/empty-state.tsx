...
export function EmptyState({
  ...
  return (
    <div className="rounded-[var(--r-lg)] border border-[color:var(--border-subtle)] bg-[color:var(--surface-1)] p-5 text-center sm:p-8">
      ...
      <h3 className="mt-5 text-lg font-semibold text-[color:var(--text-primary)] sm:text-xl">{title}</h3>
